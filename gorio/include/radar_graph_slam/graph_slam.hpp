...
public:
  ...
  /**
   * @brief ground plane agreement between two consecutive keyframes: three
   * degrees of freedom, the relative roll and pitch against the surface and the
   * height above it, with no assumption that the surface is level.
   */
  g2o::EdgeSE3PlaneRelative* add_se3_plane_relative_edge(
      g2o::VertexSE3* v1, g2o::VertexSE3* v2, const Eigen::Vector4d& plane_1,
      const Eigen::Vector4d& plane_2, const Eigen::MatrixXd& information_matrix);
