...
{
  GyroVelData() : dt{0} {}
  GyroVelData(const double dt, const Vector3& a_b_ib, const Vector3& w_b_ib) : dt{dt}, a_b_ib{a_b_ib}, w_b_ib{w_b_ib} {}
...
struct GyroVelDataStamped
{
  GyroVelDataStamped() : dt{0} {}
  GyroVelDataStamped(const ros::Time& time_stamp,
  ...
  GyroVelDataStamped(const sensor_msgs::ImuConstPtr& imu_msg, const Real dt) :
