...
G2O_REGISTER_TYPE(EDGE_SE3_PLANE_RELATIVE, EdgeSE3PlaneRelative)
}  // namespace g2o
...
g2o::EdgeSE3PlaneRelative* GraphSLAM::add_se3_plane_relative_edge(
  ...
  g2o::EdgeSE3PlaneRelative* edge(new g2o::EdgeSE3PlaneRelative());
  edge->setPlanes(plane_1, plane_2);
  edge->setInformation(information_matrix);
  edge->vertices()[0] = v1;
  edge->vertices()[1] = v2;
  graph->addEdge(edge);
